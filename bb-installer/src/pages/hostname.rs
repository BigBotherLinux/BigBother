...
pub fn render(ui: &mut egui::Ui, state: &mut InstallerState) {
    ui.vertical_centered(|ui| {
        ...
        ui.add_space(5.0);
        ui.label(theme::muted_text("Designate your node in the BigBother network"));
    });
    ...
    ui.horizontal(|ui| {
        for suggestion in ["bigbother-node", "citizen-terminal", "monitoring-station", "thought-box"] {
